...
export function ProfileMePage() {
    ...
    return (
        <div className="sm:w-5/12 mx-auto min-h-screen grid grid-cols-1 gap-2 content-start">
                    ...
                    <div className="mt-1 space-y-1">
                        <div className="flex items-center gap-x-3">
                            <input 
                                ...
                                className="h-4 w-4 border-gray-600 bg-gray-500 text-indigo-600 focus:ring-indigo-600"
