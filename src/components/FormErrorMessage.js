export default function FormErrorMessage({message, handleErrClose}) {
    return (
        <div className=" bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative sm:max-w-lg" role="alert">
